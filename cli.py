...
def load_favorite_papers(favorite_papers_path: str, fetcher: ArxivFetcher) -> list[Paper]:
    """
...
def main():
    ...
    favorite_papers = load_favorite_papers(config.favorite_papers_path, fetcher)
